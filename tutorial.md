...
We also strongly recommend that you familiarize yourself with the Load balanced managed VMs solution by reading the [solution guide](https://cloud.google.com/architecture/reliability/load-balanced-vms).
